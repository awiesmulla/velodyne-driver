...
def main():
    ...
    data_acc = np.genfromtxt("./Data/2021-12-09/2021-12-09_run1_acc.csv",delimiter=',')
    data_yaw = np.genfromtxt("./Data/2021-12-09/2021-12-09_run1_yaw.csv",delimiter=',')
    data_gps = np.genfromtxt("./Data/2021-12-09/2021-12-09_run1_gps.csv",delimiter=',')

    a_x = lp_filter(data_acc[1:,2] * -1)
    a_y = lp_filter(data_acc[1:,1])
    w_z = (data_yaw[1:,1])
    data_gps = data_gps[1:]
